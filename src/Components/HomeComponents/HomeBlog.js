                    ...
                    <div className="news-col-wrap">
                        <div className="news-col-one">
                            <div className="news-card-two">
                                <div className="news-card-img">
                                    <img style={{height:"100%",width:"100%"}} src={props?.data[0]?.HeadingImage?.url?props?.data[0]?.HeadingImage?.url:"../assets/img/news/news-1.webp"} alt="Image" />
                        ...
                        <div className="news-col-two">
                            <div className="news-card-four">
                                ...
                                <div className="news-card-info">
                                <h3><a href="#">{props?.data[4]?.Title?props?.data[4]?.Title:"-------"}</a></h3>
                                    <ul className="news-metainfo list-style">
                                    <li><i className="fi fi-rr-calendar-minus" /><a href="#">{getDate(props?.data[4]?.Date)}</a></li>
                                    <li><i className="fi fi-rr-user" />{props?.data[4]?.Author?props?.data[4]?.Author:"----"}</li>
                                    </ul>
                                </div>
                            </div>
                            {
                        ...
                        <div className="news-col-three">
                            <div className="news-card-two">
                                <div className="news-card-img">
                                    ...
                                    <a  className="news-cat">{props?.data[7]?.Category?props?.data[7]?.Category:"------"}</a>
                                </div>
                                <div className="news-card-info">
                                    <h3><a >{props?.data[7]?.Title?props?.data[7]?.Title:"-----"}</a></h3>
                                    <ul className="news-metainfo list-style">
                                        <li><i className="fi fi-rr-calendar-minus" /><a >{getDate(props?.data[7]?.Date)}</a></li>
                                        <li><i className="fi fi-rr-user" />{props?.data[7]?.Author?props?.data[7]?.Author:"---"}</li>
                                    </ul>
                                </div>
                            </div>
                            {getData(8,10)}
